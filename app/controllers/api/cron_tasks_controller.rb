  ...
  def send_daily
    ...
    if request.headers['Authorization'] == "Bearer #{ENV.fetch('CRON_TOKEN', nil)}"
      ...
      daily_messages = [
        ...
        { title: 'ジョギングしよう！', body: 'VO2max（最大酸素摂取量）が低いと死亡率が3～5倍になり、喫煙や高血圧よりも危険だよ！' },
        { title: 'たつマジロのVO2MAXは53！', body: 'VO2MAXが低いグループより、総死亡率が4～5倍も低いよ！' },
        ...
        { title: 'VILPA（高強度間欠的身体活動）をしよう！', body: '1日にたった3〜4回、それぞれ1分ずつのVILPAを行うだけで、全死亡リスクが約40%も下がるよ！' },
        { title: '週30分〜60分の筋トレで、総死亡率が10〜17%も下がるよ！', body: '週130分〜140分以上の筋トレは、逆に死亡率が上がるので注意！' }
      ]
